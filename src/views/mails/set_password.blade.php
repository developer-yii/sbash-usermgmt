...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>{{ __('orgmgmt')['mails']['invite_title']}}</title>
    <style>
      .wrapper {
        width: 100%;
      }
              ...
              <tbody>
                <tr>
                  <td>
                    ...
                    <center data-parsed="">
                        <img src="{{ asset('/vendor/orgmgmt/img/cropped-logo_sbs_headline_small.png') }}" alt="Setaro Logo">
                    </center>
                    <table class="spacer">
                      <tbody>
                        <tr>
                                                    ...
                                                    <table class="callout">
                                                      <tr>
                                                          <th class="callout-inner">
                                                              <!-- <p class="space-bottom">{{__('orgmgmt')['mails']['kindly_take_action']}}</p> -->
                                                              <p>
                                                                  <table>
                                                                      <tbody>
                                                                          <tr>                                                                                
